                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="site-branding">
                                ...
                                <h1 class="site-title m-0"><a
                                        ...
                                        rel="home"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/PJ_Logo.svg" alt="Philip John"></a>
                                </h1>
                                <?php
                                else :
                                    ?>
                                ...
                                if ($cherry_blog_description || is_customize_preview()) :
                                    ?>
                                <p class="site-description m-0 clsDescription"><?php echo $cherry_blog_description; /* WPCS: xss ok. */ ?>
                                </p>
                                <?php endif; ?>
                            </div><!-- .site-branding -->
                        </div>
